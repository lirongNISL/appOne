  ...
  <script>
    ...
    function draw(x, y, isDown, isclean){
        if (isDown) {
            ...
            ctx.beginPath();
            var color=penColor?penColor:'red';
    ...
    return (
      <View style={[styles.container, {width:this.state.width, height:this.state.height}]}>  
        ...
        <TouchableOpacity onPress={() => this.webview.reload()}>
          <LinearGradient colors={['#0055CC', '#66A6FF']} style={{ width: this.state.width - 20, height: 50, alignItems: "center", borderRadius: 10 }}>
